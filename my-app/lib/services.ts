...
const SERVICE_DEFINITIONS: ServiceDefinition[] = [
  {
    ...
    specialistIds: ["alexey", "vyacheslav", "anastasia"],
  ...
  },
  {
    ...
    specialistIds: ["maria", "anastasia", "elizaveta"],
  ...
  },
  {
    ...
    specialistIds: ["anastasia", "alexey", "maria"],
  ...
  },
  {
    ...
    section: "popular",
    icon: "/often/edit.svg",
    specialistIds: ["elizaveta", "maria", "ivan"],
  ...
  },
  {
    ...
    specialistIds: ["alexey", "arina", "ivan"],
    ...
    locale: {
      ...
      ru: {
        ...
        summary: "Настраиваем события, цели и отчёты так, чтобы маркетинг опирался на реальные данные о конверсии.",
  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        title: "UX/UI-дизайн",
        summary: "Проектируем интерфейсы вокруг задач пользователя, логики сценариев и конверсии.",
  ...
  },
  {
    ...
    specialistIds: ["alexey", "anastasia", "ivan"],
    ...
    locale: {
      ...
      ru: {
        ...
        summary: "Проводим контролируемые тесты, чтобы улучшать конверсию не на ощущениях, а на фактах.",
  ...
  },
  {
    ...
    specialistIds: ["anastasia", "elizaveta", "maria"],
  ...
  },
  {
    ...
    specialistIds: ["anastasia", "elizaveta"],
  ...
  },
  {
    ...
    specialistIds: ["ivan", "anastasia", "elizaveta"],
