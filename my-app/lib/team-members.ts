  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        ...
        intro:
          "Mia Nolan — SMM-специалист, которая отвечает за редакционный план, вовлечение аудитории и рост каналов для брендов, где соцсети должны поддерживать спрос. Она связывает продакшн контента с понятными бизнес-целями.",
        metaDescription:
          "Mia Nolan — SMM-специалист. Контент-план, вовлечение аудитории и рост соцсетей, связанные с реальными задачами бизнеса.",
        imageAlt:
          "Mia Nolan, SMM-специалист, портрет для страницы команды агентства",
        activitySummary:
  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        ...
        intro:
          "Evan Brooks — SEO-стратег, который работает с техническим аудитом, кластеризацией семантики и архитектурой страниц для компаний, где органический трафик должен поддерживать продажи. Он фокусируется на коммерческом интенте и долгосрочном росте из поиска.",
        metaDescription:
          "Evan Brooks — SEO-стратег. Техническое SEO, архитектура страниц, семантика и рост органического трафика для коммерческих сайтов.",
        imageAlt:
          "Evan Brooks, SEO-стратег, портрет для страницы команды агентства",
        activitySummary:
  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        ...
        intro:
          "Lina Hayes — визуальный дизайнер, которая создаёт бренд-системы, рекламные креативы и визуал лендингов для команд, которым нужна более сильная коммерческая подача. Она связывает дизайн с позиционированием, ясностью оффера и поведением пользователя.",
        metaDescription:
          "Lina Hayes — визуальный дизайнер. Бренд-системы, рекламные креативы и визуал лендингов, которые усиливают ясность и конверсию.",
        imageAlt:
          "Lina Hayes, визуальный дизайнер, портрет для страницы команды агентства",
        activitySummary:
  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        ...
        intro:
          "Noah Reed — проектный менеджер, который держит маркетинговое исполнение в структуре: по каналам, срокам и коммуникации со стейкхолдерами. Он переводит бизнес-приоритеты в конкретные задачи, ответственных и этапы запуска для всей команды.",
        metaDescription:
          "Noah Reed — проектный менеджер. Координация реализации, коммуникация со стейкхолдерами и управление маркетинговым производством.",
        imageAlt:
          "Noah Reed, проектный менеджер, портрет для страницы команды агентства",
        activitySummary:
  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        ...
        experience: "7 лет опыта",
        intro:
          "Ella Stone — контент-стратег, которая отвечает за коммерческие смыслы, редакционное планирование и SEO-aware контент-системы. Она помогает бизнесу понятнее объяснять услуги и поддерживать конверсию на сайте, в рекламе и email-цепочках.",
        metaDescription:
          "Ella Stone — контент-стратег. Коммерческие смыслы, редакционное планирование и SEO-структура для сайта и маркетинговых кампаний.",
        imageAlt:
          "Ella Stone, контент-стратег, портрет для страницы команды агентства",
        activitySummary:
  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        ...
        intro:
          "Max Turner — специалист по paid media, который работает с сегментацией аудиторий, тестированием креативов и стабилизацией рекламных кампаний в соцсетях. Он помогает бизнесу находить масштабируемые связки сообщения, плейсмента и бюджета.",
        metaDescription:
          "Max Turner — специалист по paid media. Сегментация аудиторий, тесты креативов и стабилизация кампаний в соцсетях.",
        imageAlt:
          "Max Turner, специалист по paid media, портрет для страницы команды агентства",
        activitySummary:
  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        ...
        experience: "6 лет опыта",
        intro:
          "Nina Cole — UX/UI-дизайнер, которая выстраивает коммерческие сайты, лендинги и цифровые интерфейсы вокруг ясности и конверсии. Она работает там, где дизайн должен снимать трение и вести пользователя к следующему действию.",
        metaDescription:
          "Nina Cole — UX/UI-дизайнер. Конверсионная структура сайта, UX лендингов и понятные цифровые интерфейсы для роста бизнеса.",
        imageAlt:
          "Nina Cole, UX/UI-дизайнер, портрет для страницы команды агентства",
        activitySummary:
  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        ...
        experience: "6 лет опыта",
        intro:
          "Ryan Blake — эксперт по локальному SEO, который усиливает видимость в картах, локальные посадочные страницы и оптимизацию профилей для бизнеса, зависящего от регионального спроса. Его фокус — видимость, доверительные сигналы и конверсионный путь по геозапросам.",
        metaDescription:
          "Ryan Blake — эксперт по локальному SEO. Локальная выдача, видимость в картах и поисковая оптимизация для бизнеса с региональным спросом.",
        imageAlt:
          "Ryan Blake, эксперт по локальному SEO, портрет для страницы команды агентства",
        activitySummary:
  ...
  },
  {
    ...
    locale: {
      ...
      ru: {
        ...
        experience: "8 лет опыта",
        intro:
          "Sara Quinn — руководитель бренд-контента, которая держит редакционную целостность сайта, кампаний и growth-контента. Она помогает компаниям превращать экспертизу в материалы с доказательной базой, которые усиливают доверие и продажи.",
        metaDescription:
          "Sara Quinn — руководитель бренд-контента. Редакционная целостность, proof-driven тексты и контент-системы для роста бизнеса.",
        imageAlt:
          "Sara Quinn, руководитель бренд-контента, портрет для страницы команды агентства",
        activitySummary:
